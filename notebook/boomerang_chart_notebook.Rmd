...
animated_plot <- p +
  transition_states(living_location, transition_length = 0.3, state_length = 0.1) +
  ease_aes('quadratic-in-out')

animate(animated_plot, width = 700, height = 300, fps = 30)

anim_save(width = 700, height = 300, fps = 20, filename = "animations/residency_animation.gif")
```
